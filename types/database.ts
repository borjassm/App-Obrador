  ...
  public: {
    Tables: {
      ...
      sales_daily: {
        ...
        Update: Partial<Database['public']['Tables']['sales_daily']['Insert']>;
      };
      daily_sessions: {
      ...
      daily_product_entries: {
        ...
        Update: Partial<Database['public']['Tables']['daily_product_entries']['Insert']>;
      };
      product_costs: {
      ...
      production_teams: {
        ...
        Update: Partial<Database['public']['Tables']['production_teams']['Insert']>;
      };
      sales_raw: {
        ...
        Update: Partial<Database['public']['Tables']['sales_raw']['Insert']>;
      };
    };
